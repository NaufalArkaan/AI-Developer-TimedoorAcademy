...
detector = fmd.FaceMesh()      #Inisialisasi object detector dari class FaceMesh yang sudah di buat
cap = cv2.VideoCapture(0)
cap.set(3,1280) # mengatur lebar canvas    #
cap.set(4,960)  # mengatur tinggi canvas   #
left_eye = cv2.imread('./FaceFilterDragon/assets/eye1.png')   # Load gambar dan video untuk filter dragon
